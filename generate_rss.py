...
MAX_SEEN_COMICS = 500  # Limit number of comics in seen list to keep the file small
...
# Save seen comics to a file, limiting the size of the list
def save_seen_comics(seen_comics):
    # Limit the list size
    if len(seen_comics) > MAX_SEEN_COMICS:
        seen_comics = seen_comics[-MAX_SEEN_COMICS:]  # Keep only the last MAX_SEEN_COMICS entries
